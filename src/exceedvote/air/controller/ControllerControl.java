...
/**
 * Mediator between ControlPanel and Committee which manage about setTime ,add
 * criteria, add team etc.
 * 
 * @author AirTeam
 */
public class ControllerControl {
	...
	public static ControllerControl getInstance() {
		if (controllerControl == null)
			controllerControl = new ControllerControl();
	 ...
	 * 
	 * @param selectDay
	 *            given date be string (such as"31")
	 * @param selectMonth
	 *            given month be string
	 * @param selectYear
	 *            given year (B.C.) be string (such as "2012")
	 * @param hour
	 *            given hour be string
	 * @param min
	 *            given minute be string
	 * @param second
	 *            given second be string
	 */
	public void setTime(String selectDay, String selectMonth,
			String selectYear, String hour, String min, String second) {

		committee
				.setTime(selectDay, selectMonth, selectYear, hour, min, second);
	}
	 ...
	 * 
	 * @param committee
	 *            the person that login to use controlpanel.
	 */
	 ...
	 * 
	 * @param topicName
	 *            is name of topic that want to add
	 ...
	 * 
	 * @param teamName
	 *            is name of team that want to add
	 * @param pic
	 *            , Picture files(jpg,png etc.) identity of team
	 * @param descriptionText
	 *            , description software of this team
		...
		for (int i = 0; i < score.size(); i++) {
			for (int j = 0; j < list.size(); j++) {
				if (score.get(i).equals(
						Integer.parseInt(list.get(j).get(1).toString()))) {
